...
import etc_1 from '../../images/etc1-1.png';
...
const IllegalAreaGuide = () => {
  ...
  let etc1 = { backgroundImage: `url(${etc_1})` };
              ...
              <div className="col-6 col-sm-12">
                <div className="guideTxt">
                  <div className="gtTop">
                    <h3>소화전 불법주정차</h3>
                    <p>
                      주정차 금지 교통안전표지가 설치된 5M 이내 정지 상태 차량
                    </p>
                  </div>
                  ...
                  <ul className="checkTxt">
                    ...
                    <li>
                      경계석 또는 도로바닥에 적색으로 표시된 경우는 소화전이
                      보이지 않아도 신고 가능
                    </li>
                  </ul>
                </div>
              ...
              <div className="col-6 col-sm-12">
                <div className="guideTxt">
                  <div className="gtTop">
                    <h3>버스정류소 불법주정차</h3>
                    <p>
                      정류소 표지판 좌우 및 노면표시선 기준 10M 이내 정지 상태
                      차량
                    </p>
                  </div>
                </div>
              ...
              <div className="col-6 col-sm-12">
                <div className="guideTxt">
                  <div className="gtTop">
                    ...
                    <p>
                      초등학교 어린이 보호구역 주 출입문 앞 도로의 정지 상태
                      차량 <br />
                      <strong className="ft_og">(평일 08시~20시)</strong>
                    </p>
                  </div>
                  <ul className="checkTxt">
                    <li>
                      어린이 보호구역 불법주정차 단속 요건 (구역, 시간 등)은 각
                      지자체의 행정예고에 따라 일부 다르게 운영될 수 있음
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="col-6 col-sm-12">
                <div className="guideTxt">
                  <div className="gtTop">
                    ...
                    <p>
                      환경친화적 자동차의 개발 및 보급 촉진에 관한 법률 제11조의
                      2 제7항 및 제8항을 위반하여 충전구역 및 전용주차구역에
                      주차한 경우와 같은법 시행령 제18조의 8에 해당하는 충전
                      방해 행위 기준에 해당하는 경우
                    </p>
                  </div>
                  <ul className="checkTxt">
                    <li>
                      전용주차구역(충전구역 포함) 표시가 있어야 과태료 부과처분
                      가능
                    </li>
                    <li>
                      단속 시점을 기준으로 다음날까지 신고 가능하고, 과태료 부과
                      여부 결정 및 민원처리 업무 등은 각 지자체 소관으로
                      지자체별로 다르게 운영될 수 있음
                    </li>
                  </ul>
                </div>
            ...
            <div className="guideBox">
              <div className="col-6 col-sm-12">
                <div className="guideImg">
                  ...
                  >
                    <SwiperSlide>
                      <div style={etc1} className="slideImg"></div>
                    </SwiperSlide>
                    {/* <SwiperSlide>
                      <div style={bus2} className="slideImg"></div>
                    </SwiperSlide> */}
